...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      '@innovation-os/foundation/env': pkg('foundation/src/env/index.ts'),
      '@innovation-os/foundation/config': pkg('foundation/src/config/index.ts'),
      '@innovation-os/foundation/validation': pkg('foundation/src/validation/index.ts'),
      '@innovation-os/foundation/telemetry': pkg('foundation/src/telemetry/index.ts'),
